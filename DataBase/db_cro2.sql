...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_cro` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
(1,'admin','309f5c6ecfb7ce62e35f73c464e3ada5','2226458494@qq.com',1,'1575221776','7b4fcfd63aab0546bc5ef571932fded4');
...
CREATE TABLE `base` (
  `id` int(2) NOT NULL AUTO_INCREMENT COMMENT '记录编号',
...
(1,'荷兰阿姆斯特丹自由大学教授','荷兰阿姆斯特丹自由大学教授\r\n','荷兰阿姆斯特丹自由大学教授','15210404762','15210404762','15210404762','15210404762','office@lionbiotech.com','2226458494@qq.com','style/images/logo_red.png','style/images/5435c56a66413fa9c7ea9fe2dbbc157c.png','2019年07月09日'),
(2,'','','','','','','','','','','','2019年07月09日');
...
DROP TABLE IF EXISTS `companyintr`;
...
/*Data for the table `companyintr` */
...
DROP TABLE IF EXISTS `companyphilosophy`;

CREATE TABLE `companyphilosophy` (
  `id` int(3) NOT NULL AUTO_INCREMENT COMMENT '公司理念id',
...
/*Data for the table `companyphilosophy` */
...
DROP TABLE IF EXISTS `contratcs`;

CREATE TABLE `contratcs` (
  `id` int(5) NOT NULL AUTO_INCREMENT COMMENT '合同服务序号',
...
CREATE TABLE `employee` (
  `id` int(5) NOT NULL AUTO_INCREMENT COMMENT '人才招聘信息编号',
...
CREATE TABLE `encouragement` (
  `id` int(5) NOT NULL AUTO_INCREMENT COMMENT '激励保障记录编号',
...
/*Data for the table `encouragement` */
...
CREATE TABLE `faqquestion` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'FAQ问题编号',
...
/*Data for the table `faqquestion` */
...
CREATE TABLE `manufacture` (
  `id` int(5) NOT NULL AUTO_INCREMENT COMMENT '代加工服务编号',
...
CREATE TABLE `message` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '留言编号',
...
CREATE TABLE `milestone` (
  `id` int(3) NOT NULL AUTO_INCREMENT COMMENT '里程碑id',
...
CREATE TABLE `news` (
  `id` int(7) NOT NULL AUTO_INCREMENT COMMENT '新闻编号',
  ...
  `pageview` int(10) DEFAULT '0' COMMENT '阅读量',
...
CREATE TABLE `organization` (
  `id` int(1) NOT NULL AUTO_INCREMENT COMMENT '编号',
...
(1,'青霉素酶冻干粉LBPlbp','药检试剂','β-内酰胺酶Ⅰ(青霉素酶)','普通商品','青霉素酶又称β-内酰胺酶Ⅰ（β-lactamase，EC 3.5.2.6），可水解β-内酰胺类抗生素。本公司采用生物技术，通过色谱层析技术分离纯化，获得了高效的β－内酰酶。其具有纯度高、活性高、专一性强等特点。 我们采用反相高效液相色谱法（RP-HPLC）、分子筛高效液相色谱法（SEC-HPLC）及还原和非还原电泳法（reducing and non-reducing SDS-PAGE）等三种方法对其纯度进行分析，其结果均达到90%以上。\r\n\r\n对本品的活性测定采用了《中国药典》（2015版第四部）收载的“青霉素酶活力测定法”。该法灵敏度好，精密度高，重复性强，能够有效的控制本品质量。',0,99,0,'2017-03-03 03:10',4,0,'1、 可以有效的水解β-内酰胺类抗生素，包括：\r\n\r\n①青霉素G；\r\n\r\n②氨基青霉素类，如氨苄西林、阿莫西林、匹氨西林等；\r\n\r\n③羧基青霉素类，如羧苄西林、替卡西林等；\r\n\r\n④脲基青霉素类，如呋苄西林、美洛西林等；\r\n\r\n⑤头孢一代及部分头孢二代。\r\n\r\n2、 可用于注射用β-内酰胺类抗生素药品检验中的无菌检测。\r\n\r\n3、 可用于口服及其它β-内酰胺类抗生素药品检验中的微生物限度检测。','productPics/601qmsdg.jpg','productPics/601qmsdg.jpg','','','','≥1000万单位/支 8支/盒','24个月','冻干','详见《中国药典》（2015版二部）。','2～8℃保存。','Q/HLB 0001-2016',34),
...
CREATE TABLE `resume` (
  `id` int(6) NOT NULL AUTO_INCREMENT COMMENT '简历编号',
...
CREATE TABLE `smallkind` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '小种类id',
...
CREATE TABLE `speech` (
  `id` int(2) NOT NULL AUTO_INCREMENT COMMENT '领导致辞纪录id',
...
CREATE TABLE `staff` (
  `id` int(3) NOT NULL AUTO_INCREMENT COMMENT '员工培养记录编号',
...
CREATE TABLE `talents` (
  `id` int(5) NOT NULL AUTO_INCREMENT COMMENT '人才理念id',
...
DROP TABLE IF EXISTS `techkinds`;

CREATE TABLE `techkinds` (
  `id` int(2) NOT NULL AUTO_INCREMENT COMMENT '科技服务模块编号',
...
DROP TABLE IF EXISTS `techservices`;

CREATE TABLE `techservices` (
  `id` int(5) NOT NULL AUTO_INCREMENT COMMENT '服务编号',
...
/*Data for the table `techservices` */
...
CREATE TABLE `travel` (
  ...
  `id` int(5) NOT NULL AUTO_INCREMENT COMMENT '公司福利编号',
  PRIMARY KEY (`id`)
