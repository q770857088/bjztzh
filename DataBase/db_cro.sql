...
(1, 'admin', 'f379eaf3c831b04de153469d1bec345e', '1611274445@qq.com', 1, '1567567677', '7b4fcfd63aab0546bc5ef571932fded4');
...
(1, '北京智通智慧科技有限公司', '北京智通智慧科技有限公司坐落在人间天堂—杭州，建立了中药、化学药研究开发团队，为药物研究开发提供了全面的技术服务平台。', '杭州市拱墅区祥园路39-2号5幢5楼501室-18', '0571-858375', '0571-882578', '0571-858375', ' 0571-85837527', 'office@lionbiotech.com', ' sales@lionbiotech.com', 'style/images/logo_red.png', 'style/images/5435c56a66413fa9c7ea9fe2dbbc157c.png', '2019年07月09日'),
(2, '', '', '', '', '', '', '', '', '', '', '', '2019年07月09日');
...
CREATE TABLE `companyIntr` (
  `id` int(10) NOT NULL COMMENT 'id',
  `description1` varchar(1000) COLLATE utf8_unicode_ci NOT NULL DEFAULT '北京智通智慧科技有限公司成立于2007年12月，是一家集新药研究技术服务、药品相关试剂销售为一体的高科技公司。公司致力于生物试剂、医药中间体和药用辅料的研究开发、制造与贸易，同时提供与药品开发相关的技术服务，如化药、中药临床前研究（包括处方筛选、工艺优化、质量研究、稳定性考察等）。' COMMENT '公司介绍文字段落1',
...
CREATE TABLE `companyPhilosophy` (
  ...
  `goal` varchar(1000) COLLATE utf8_unicode_ci NOT NULL DEFAULT '北京智通智慧科技有限公司致力于创新和发展，立志在制药、食品安全检测、生物研究用试剂等高科技领域为客户提供优质服务，引导客户迈向成功。' COMMENT '企业愿景'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(3, '不求效益最大，但求问心无愧；不求品种很多，但求产品精益；药品质量关系患者健康，产品质量关系企业名誉。品牌的核心：品质。', '北京智通智慧科技有限公司致力于创新和发展，立志在制药、食品安全检测、生物研究用试剂等高科技领域为客户提供优质服务，引导客户迈向成功。'),
(4, '', '');
...
(3, '北京智通智慧科技有限公司致力于创新和发展，立志在制药、食品安全检测、生物研究用试剂等高科技领域为客户提供优质服务，引导客户迈向成功。', '在未来，北望将继续顺应潮流、抓住机遇、转变观念、开拓创新，以优秀的文化孕育人，以成熟的管理塑造人，以优势的薪酬激励人，与全体北望同仁一道，共同推动北望的更大发展，开创北望事业发展新的辉煌。');
...
--
ALTER TABLE `base`
  MODIFY `id` int(2) NOT NULL AUTO_INCREMENT COMMENT '记录编号', AUTO_INCREMENT=3;
...
--
ALTER TABLE `news`
  MODIFY `id` int(7) NOT NULL AUTO_INCREMENT COMMENT '新闻编号', AUTO_INCREMENT=13;
